  ...
  return (
    <>
      <style>{`
        ...
        .mc-optin-section { max-width: 700px; margin: 48px auto 0; padding: 0 24px; animation: fadeUp 1s ease 0.25s both; }
        ...
        /* Blend the Kit form into the dark page */
        .mc-optin-section .formkit-form { box-shadow: 0 24px 80px rgba(0,0,0,0.5) !important; border: 1px solid rgba(201,168,76,0.2) !important; }
